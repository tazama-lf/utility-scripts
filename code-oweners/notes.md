## Code owners Script for Tazama-lf and Frmscoe  with GitHub CLI Script

What This Will Do:

- Check for each repo if a codeowners file exists and add the github usernames decsribed as code owners for those repos.
